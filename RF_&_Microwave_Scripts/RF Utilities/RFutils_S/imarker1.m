function Sinterp=imarker1(Snn,Freq,Zo,Markers,Mnumber)
% Return Loss Marker
%
% Draws a single marker on Insertion Loss plot at frequency specified
% by Marker. Returning the interpolated S-param value. It allows 
% individual markers to be applied to different plots.
%
% Usage: Sinterp=imarker1(Snn,Freq,Zo,Marker,Mnumber)
%
...
%
% e.g. ilossc(S21,Freq,Zo);
%      imarker1(S21,Freq,50,880,1)
...
hold on;
L1=20.*log10(abs(Ymarker));      % Insertion loss dB
plot(Xmarker,L1,'+','color','k','LineWidth',2);
