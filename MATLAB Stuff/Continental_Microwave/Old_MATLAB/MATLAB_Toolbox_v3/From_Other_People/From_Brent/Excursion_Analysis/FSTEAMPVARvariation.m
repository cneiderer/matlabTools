...
normal        = 0;  %turns off manual window display


file='C:\SAT 1743 Data\System\SAT1736SN005\RX\14.615.cti';
...
%         text(freq(1),AMPSLA(1),['Exceeds SPEC : ',num2str(GS),'dB :('],'VerticalAlignment','top','fontweight','bold')
    ...
    %Pick up the max variation w1 and w2
    
    [w1MaxVar(ii),w2MaxVar(ii)]=Var(PMfDV,PMAVV,lengthw1);
 ...
 alpha(spec_alpha);
 hold on;
 plot(fc,(w2MaxVar),'b','LineWidth',2.0)
