function IDD_resonator_loaded_vbs(varargin)

%
% IDD_resonator_loaded_vbs.m
%
% Description:
%   Builds macro to create a interdigital filter with resonator loading  
%   within HFSS based on WEAFIL IDD data file.
%
% Inputs:
