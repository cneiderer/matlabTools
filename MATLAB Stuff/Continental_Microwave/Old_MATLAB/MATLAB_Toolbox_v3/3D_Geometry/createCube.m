function [vertices,faces,edges] = createCube(varargin)
...
%   HISTORY
%   04/01/2007: David Legland
%               remove unused variables
%   03/20/2009: Curtis Neiderer
%               add varargin input argument option
%               
%               example:
%               [vertices,edges,faces]=createCube([0,0,0],[1,1,1])
%


if nargin==2
    x0=varargin{1}(1); dx=varargin{2}(1);
    y0=varargin{1}(2); dy=varargin{2}(2);
    z0=varargin{1}(3); dz=varargin{2}(3);
else
    x0=0; dx=1;
    y0=0; dy=1;
    z0=0; dz=1;
