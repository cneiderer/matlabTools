function [] = load_personal_toolbox(varargin)

%
% load_personal_toolbox.m
%
% Description:
%   Loads your personal toolbox and changes to current directory to the  
%   selected toolbox path.
%
% Inputs:
%   varargin{1} = toolbox_path      ->  Path to your personal toolbox
%
% Outputs:
%   N/A
%
% Author:
%   Curtis Neiderer, 2/26/2009
%

%% Set toolbox path
% if nargin==1
%     toolbox_path=varargin{1};
% else
%     toolbox_path=uigetdir('C:\','Select your personal toolbox:')
% end
% toolbox_path='C:\Revamped_MATLAB_Toolbox';
toolbox_path='C:\MATLAB_Toolbox';

%% Recursively add toolbox paths to the MATLAB path
addpath_recurse(toolbox_path)

%% Change directory to personal toolbox
cd(toolbox_path);
