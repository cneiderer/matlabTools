...
set(handles.fL,'String',WG_list{WG_index,5});
set(handles.fH,'String',WG_list{WG_index,6});
set(handles.freq_band,'String',WG_list{WG_index,1});
...
WG_list={...
    ...
    'Q-Band','WR-22','0.224','0.1120','33.00','50.00';...
    'Ka-Band','WR-28','0.280','0.1400','26.50','40.00';...
    '???','WR-34','0.340','0.1700','22.00','33.00';...
    'K-Band','WR-42','0.420','0.1700','18.00','26.50';...
    'K-Band','WR-51','0.510','0.2550','15.00','22.00';...
    'Ku-Band','WR-62','0.622','0.3110','12.40','18.00';...
    'Ku-Band','WR-67','0.668','0.3400','???','???';...
    'X-Band','WR-75','0.750','0.3750','10.00','15.00';...
    'X-Band','WR-90','0.900','0.4000','8.20','12.40';...
    '???','WR-96','0.965','0.3200','???','???';...
    '???','WR-102','1.020','0.5100','7.00','11.00';...
    'H-Band','WR-112','1.122','0.4970','7.05','10.00';...
    'C-Band','WR-137','1.372','0.6220','5.85','8.20';...
    'F-Band','WR-159','1.590','0.7950','4.90','7.05';...
    'G-Band','WR-187','1.872','0.8720','3.95','5.85';...
