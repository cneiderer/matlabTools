function xrotc_array(ang,elstart,elfinish)
% Rotate and copy array geometry about x-axis, rotation is relative
% to the current orientation, new elements are added onto the end
% of array_config.
%
% Usage : xrotc_array(ang,elstart,elfinish)
%
...
fprintf('Rotate-copy elements %i to %i around X-axis by %3.2f Deg\n',...
