...
%
% Comparison with NEC model '3dipoles'
%
% The correlation in this example is almost exact, this is because
% the mutual coupling effects are minimised by the orthogonality
% between elements.
...
% Construct the array
N=1;
rect_array(1,N,0,0,'dipole',-90); % 6-element array dipoles over ground at 45 deg
xrot_array(-45,1,1);
...
[phi30p,Emulti30p]=phi_cut(0,5,360,30);
fprintf('60 Deg phi cut \n');
[phi60p,Emulti60p]=phi_cut(0,5,360,60);
fprintf('90 Deg phi cut \n');
[phi90p,Emulti90p]=phi_cut(0,5,360,90);
