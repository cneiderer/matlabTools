...
%
% A 2x2 array of 6-turn helicies on a groundplane.
% The array spacing is 1.2 lambda in X and Y directions. Freq=300 MHz
%
% Comparison with NEC model 'helix2p4'
%
% The total field correlation in this example is good for the
% main lobe and fair for the side-lobes. The results for the Vertical 
...
% more complex model to obtain accurate results. Further emphasised here
% by mutual coupling effects between the longer 6-turn elements. The example
% highlights the risks of using electrically large array elements.
%
% For this application VP and HP components are assumed to be a constant
% -3dB down on the total field. 
...
helix_config=design_helix(6,300e6); % Design 6-turn helix

rect_array(2,2,1.2*lambda,1.2*lambda,'helix',0); % 2x2 Helix array
