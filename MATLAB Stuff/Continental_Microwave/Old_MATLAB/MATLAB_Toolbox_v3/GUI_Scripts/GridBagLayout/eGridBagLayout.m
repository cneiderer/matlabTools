...
% Create the figure, panel and widgets.  All of the widgets are placed on
% top of each other because of their default position values.  The layout
...
% complete the layout.  Notice that even those certain rows and columns
