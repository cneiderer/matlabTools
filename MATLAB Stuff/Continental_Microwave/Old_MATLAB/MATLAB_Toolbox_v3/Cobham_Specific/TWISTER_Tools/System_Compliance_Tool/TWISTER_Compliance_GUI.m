function varargout = TWISTER_Compliance_GUI(varargin)
% TWISTER_COMPLIANCE_GUI M-file for TWISTER_Compliance_GUI.fig
%      TWISTER_COMPLIANCE_GUI, by itself, creates a new TWISTER_COMPLIANCE_GUI or raises the existing
%      singleton*.
%
%      H = TWISTER_COMPLIANCE_GUI returns the handle to a new TWISTER_COMPLIANCE_GUI or the handle to
%      the existing singleton*.
%
%      TWISTER_COMPLIANCE_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TWISTER_COMPLIANCE_GUI.M with the given input arguments.
%
%      TWISTER_COMPLIANCE_GUI('Property','Value',...) creates a new TWISTER_COMPLIANCE_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TWISTER_Compliance_GUI_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TWISTER_Compliance_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help TWISTER_Compliance_GUI

% Last Modified by GUIDE v2.5 16-Apr-2009 08:29:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TWISTER_Compliance_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @TWISTER_Compliance_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TWISTER_Compliance_GUI is made visible.
function TWISTER_Compliance_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to TWISTER_Compliance_GUI (see VARARGIN)

% Choose default command line output for TWISTER_Compliance_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes TWISTER_Compliance_GUI wait for user response (see UIRESUME)
% uiwait(handles.System_Compliance_GUI_figure);


% --- Outputs from this function are returned to the command line.
function varargout = TWISTER_Compliance_GUI_OutputFcn(hObject, eventdata, handles) 
...
Master_FileList.nstep=str2double(get(handles.nstep_EditBox,'string'));
if (Master_FileList.nstep==0) | Master_FileList.nstep==NaN
    Master_FileList.nstep=50;
end
Master_FileList.GDSmoothie=str2double(get(handles.GDSmoothie_EditBox,'string'));
if (Master_FileList.GDSmoothie==0) | Master_FileList.GDSmoothie==NaN
...
[NB_TX_files,NB_TX_path]=uigetfile({'*.cti';'*.s2p';'*.*'},...
    'Select the NB "TX" data files to be analyzed:','MultiSelect','on');
...
function nstep_EditBox_Callback(hObject, eventdata, handles)
% hObject    handle to nstep_EditBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of nstep_EditBox as text
%        str2double(get(hObject,'String')) returns contents of nstep_EditBox as a double

test=1;

% --- Executes during object creation, after setting all properties.
function nstep_EditBox_CreateFcn(hObject, eventdata, handles)
% hObject    handle to nstep_EditBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function GDSmoothie_EditBox_Callback(hObject, eventdata, handles)
% hObject    handle to GDSmoothie_EditBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of GDSmoothie_EditBox as text
%        str2double(get(hObject,'String')) returns contents of GDSmoothie_EditBox as a double

test=1;

% --- Executes during object creation, after setting all properties.
function GDSmoothie_EditBox_CreateFcn(hObject, eventdata, handles)
% hObject    handle to GDSmoothie_EditBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
