...
if nargin==1
    ...
    [mat_file,mat_filepath]=uigetfile('*.mat','Select the *.mat measurement data file',[sys_name,'measurement_data_',datestr(now,1),'.mat']);
...
% Add new workbook
[comp_xls,comp_xlspath]=uiputfile('*.xls','Save your system compliance spreadsheet as: ',['system_compliance_',datestr(now,1),'.xls']);
