function dr = bdrwinfd(dx,Ny)

% bdrwinfd.m    BUTTON: SHOW SHORT HELP (DRAWDFIL)
%   
...
uicontrol('Style', 'text', 'String', 'BLOCK', 'Units','normalized' ...
  ,'HorizontalAlignment', 'left', 'BackgroundColor',[0.5 0.9 0.9] ...
  ,'Position',[0.16*pdraw(3)+pdraw(1) 0.58*pdraw(4)+pdraw(2) 0.12*pdraw(3) 0.045*pdraw(4)]);
text(0.3,0.60*Nydx,'draw text, block','FontSize',FontInfo)
