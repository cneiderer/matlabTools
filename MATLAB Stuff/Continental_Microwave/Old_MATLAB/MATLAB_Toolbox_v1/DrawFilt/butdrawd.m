% butdrawd  GENERATE BUTTONS: DRAW DIGITAL FILTER REALIZATIONS
%   
...
dc = 'b';
matrixEnew = ['                                                             '];
rdr = 'clf;[x,y]= drawgrid(x0,y0,dx,ds,F,Nx,Ny);bdrwredr(x0,y0,dx,ds,F,Nx,Ny,matrixE,dc);butdrawd';
...
ddfr3=  ['''EXAMPLE from example5.m''' ',''NumberTitle'', ''off'''];
ddfr4=  ['''EXAMPLE from example6.m''' ',''NumberTitle'', ''off'''];
...
uiINFO= uicontrol('String', 'info', 'Units', 'normalized' ...
     ...
     , 'CallBack', 'clf,bdrwinfd(dx,Ny);butdrawd;txtst=1;');
...
uiNEW = uicontrol('String', 'NEW', 'Units', 'normalized' ...
     ...
     'clf;[x,y]= drawgrid(x0,y0,dx,ds,F,Nx,Ny);matrixE=matrixEnew;butdrawd');
...
uiOPENFROM = uicontrol('String', 'OPEN', 'Units', 'normalized', ...
        ...
        'bdrwredr(x0,y0,dx,ds,F,Nx,Ny,matrixE,dc);butdrawd']);

callbackStr = [';[matrixE,editString]=bdrwedit(x0,y0,dx,ds,F,Nx,Ny,matrixE,editString);'];
callbackStr = [callbackStr 'editstrd;'];
...
uiex3 = uicontrol('String', '5', 'Units', 'normalized' ...
     , 'Position', [0.95 0.13 0.025 0.04], 'CallBack', ...
 ['fh2=figure(2);clf;set(fh2,''Name'',' ddfr3 ');example5(0,0,4,5,10)']);

uiex4 = uicontrol('String', '6', 'Units', 'normalized' ...
     , 'Position', [0.98 0.13 0.02 0.04], 'CallBack', ...
 ['fh2=figure(2);clf;set(fh2,''Name'',' ddfr4 ');example6(0,0,4,5,10)']);
