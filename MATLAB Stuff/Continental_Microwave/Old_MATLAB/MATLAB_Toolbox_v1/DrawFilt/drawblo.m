function dr = drawblo(c,d,f,t,n,p,s,F,dc)

% drawblo   DRAW SINGLE-INPUT SINGLE-OUTPUT BLOCK
%   
...
if p == 0
 ...
 text(a+s*0.4,b,n,'FontName','Times-Italic','FontSize',F,...
...
elseif p == 1
 ...
 text(g,h+s*0.4,n,'FontName','Times-Italic','FontSize',F,...
   'HorizontalAlignment','center','VerticalAlignment','middle')
elseif p == 2
 x = a + s*[(c-a)/s, 0.1, 0.1, 0.7, 0.7, 0.1, 0.1, 0.7, 0.7, (f-a)/s];
 y = b + s*[      0,   0, 0.3, 0.3,-0.3,-0.3, 0.3, 0.3,   0,0];
