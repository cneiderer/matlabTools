function dr = dfirlp1(x0,y0,dx,ds,F)                  
% dfirlp1.m  Filter realization                        
...
%                                                                
% call   dfirlp1(0,0,4,5,10)                           
% creation date: 24-Sep-0  time: 22:32
Nx = 7;
Ny = 5;
...
drawline(x(20), y(15), x(20), y(11), dc);                    
...
drawmult(x(20), y(7), y(10), ' ' ,'h[3]',3, ds/3, F, dc);    
drawline(x(20), y(11), x(20), y(10), dc);                    
drawadd(x(8), y(6), 2, 1, 1, 0, ' ', 1, ds/3, F, dc);        
drawadd(x(13), y(6), 2, 1, 1, 0, ' ', 1, ds/3, F, dc);       
drawadd(x(19), y(6), 2, 1, 1, 0, ' ', 1, ds/3, F, dc);       
drawline(x(10), y(6), x(13), y(6), dc);                      
drawline(x(15), y(6), x(19), y(6), dc);                      
...
drawnode(x(20), y(7), '14', 4, 1, F, dc);                    
drawnode(x(21), y(6), '15', 1, 1, F, dc);                    
...
drawtext(x(10), y(17),'FIR realization type 1', F+1, dc);    
