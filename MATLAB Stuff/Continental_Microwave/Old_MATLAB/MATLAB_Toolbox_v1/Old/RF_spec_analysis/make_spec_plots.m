...
%             [ppt_file,ppt_path]=uiputfile('*.ppt','Save file as: ',['RF_spec_analysis_figs_',datestr(now,30),'.ppt']);
%             saveas_ppt=fullfile(ppt_path,ppt_file);

            saveas_ppt=fullfile('S:\Curtis_Neiderer\MATLAB_Toolbox\',['RF_spec_analysis_figs_',datestr(now,30),'.ppt']);
        end
