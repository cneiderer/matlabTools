...
[save_name,save_path]=uiputfile('*.mat','Save spec values as .mat file',['spec_values_',datestr(now,1),'.mat'])

if save_path~=0
    save(fullfile(save_path,save_name),'specs','spec_units');
end

% save(fullfile('S:\Curtis_Neiderer\MATLAB_Toolbox',['spec_values_',datestr(now,1),'.mat']),'specs','spec_units');
