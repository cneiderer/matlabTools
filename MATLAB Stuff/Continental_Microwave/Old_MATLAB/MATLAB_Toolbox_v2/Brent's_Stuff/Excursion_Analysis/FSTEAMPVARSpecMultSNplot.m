...
nstep         = 70; %defines the number of frequency steps you wish to move the window over inside the frequency band of interest.
...
AMPYSMTH2      = 30; %Smoothing factor for 2nd input file data, must be interger greater than 1
AMPYSMTH3      = 10; %Smoothing factor for 3rd input file data, must be interger greater than 1

file='C:\MR-T RFE Data\3_26_07_SN106_DATA\SN106\RX\11.85.cti';
file2='C:\MR-T RFE Data\SAT1736SN002\RX\15.25.cti';
file3='C:\MR-T RFE Data\SAT1736SN002\RX\15.25.cti';
...
AMPY2=smooth(AMPindB2,AMPYSMTH2); %Smooths the data from the cut if needed.
...
AMPY3=smooth(AMPindB3,AMPYSMTH3); %Smooths the data from the cut if needed.
%AMPY=AMPindB;
...
AMPY2NORM=max(AMPY2);
AMPY3NORM=max(AMPY3);
plot(freqin,AMPY-AMPYNORM,'r',freqin2,AMPY2-AMPY2NORM,'b')
title('Normalized AMP comparison of Original SN002 and SN005 (Final Config)')
ylabel('dB')
xlabel('Frequency (GHz)')
legend('SN2 Full System','SN2 1/2 system')
grid on;
