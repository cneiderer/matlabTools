function drl = drawccs(c,d,f,n,t,p,s,F,dc)
...
if p == 0
 ...
 text((c+f)/2,b+s*0.3,t,'FontName','Times','FontSize',F,...
   'HorizontalAlignment','center','VerticalAlignment','bottom')
 x4 = a + s*[0.3, 0.4, 0.3];    y4 = b + s*[-0.05, 0, 0.05];
 line(x4,y4,'Color',dc)
 x4 = a + s*[0.1, 0.4];    y4 = b + s*[0, 0];
 line(x4,y4,'Color',dc)
elseif p == 1
 y = (f+d)/2 + yc1;  x = c + xc1;
 line(x,y,'Color',dc)
 ...
 x4 = g + s*[-0.05, 0, 0.05];        y4 = h + s*[0.3, 0.4, 0.3];
 line(x4,y4,'Color',dc)
 x4 = g + s*[0, 0];        y4 = h + s*[0.1, 0.4];
 line(x4,y4,'Color',dc)
elseif p == 2
 x = (f+c)/2 + xc1;          y = d + yc1;
 line(x,y,'Color',dc)
 ...
 text((c+f)/2,b-s*0.3,t,'FontName','Times','FontSize',F,...
   'HorizontalAlignment','center','VerticalAlignment','top')
 x4 = a + s*[0.2, 0.1, 0.2];    y4 = b + s*[-0.05, 0, 0.05];
 line(x4,y4,'Color',dc)
 x4 = a + s*[0.1, 0.4];    y4 = b + s*[0, 0];
 line(x4,y4,'Color',dc)
elseif p == 3
 ...
 x4 = g + s*[-0.05, 0, 0.05];        y4 = h + s*[0.2, 0.1, 0.2];
 line(x4,y4,'Color',dc)
 x4 = g + s*[0, 0];        y4 = h + s*[0.1, 0.4];
 line(x4,y4,'Color',dc)
elseif p == 4
