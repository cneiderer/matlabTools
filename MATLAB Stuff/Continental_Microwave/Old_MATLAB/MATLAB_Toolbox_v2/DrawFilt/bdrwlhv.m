function [xs,matrixE] = bdrwlhv(matrixE,x,y,ds,F,dc)
...
XS = ['                                                             '];
  title('2-segment line horizontal+vertical first point')
  [xe1,ye1]=ginput(1);   xe1 = round(xe1); ye1 =round(ye1);
  title('2-segment line horizontal+vertical last point')
