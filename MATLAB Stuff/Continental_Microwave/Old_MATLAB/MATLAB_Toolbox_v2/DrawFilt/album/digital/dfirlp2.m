function dr = dfirlp2(x0,y0,dx,ds,F)                  
% dfirlp2.m  Filter realization                        
...
%                                                                
% call   dfirlp2(0,0,4,5,10)                           
% creation date: 24-Sep-0  time: 23:12
Nx = 7;
Ny = 5;
...
drawnode(x(20), y(11), '5', 1, 1, F, dc);                    
drawnode(x(15), y(11), '6', 1, 1, F, dc);                    
drawnode(x(10), y(11), '7', 1, 1, F, dc);                    
drawnode(x(5), y(11), '8', 1, 1, F, dc);                     
drawnode(x(4), y(10), '9', 4, 1, F, dc);                     
drawnode(x(9), y(10), '10', 0, 1, F, dc);                     
drawnode(x(14), y(10), '11', 0, 1, F, dc);                   
...
drawnode(x(4), y(7), '13', 4, 1, F, dc);                     
drawnode(x(9), y(7), '14', 4, 1, F, dc);                     
drawnode(x(14), y(7), '15', 4, 1, F, dc);                    
drawline(x(4), y(15), x(5), y(15), dc);                      
drawnode(x(10), y(6), '17', 1, 1, F, dc);                    
drawnode(x(15), y(6), '18', 1, 1, F, dc);                    
...
drawnode(x(19), y(10),'12', 0, 1, F, dc);                    
drawnode(x(19), y(7), '16', 4, 1, F, dc);                    
