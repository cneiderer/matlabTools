function dr = drawap2a(x0,y0,dx,ds,F, dc);     
   
% drawap2a.m  ANSARI-LIU DIGITAL FILTER REALIZATION -- BIQUAD TYPE A
%   
...
drawadd(x(3), y(5), 2, 0, 3, 1,'S4',5,ds/3,F, dc);
drawadd(x(8), y(4), 2, 1, 0, 1,'S5',4,ds/3,F, dc);
