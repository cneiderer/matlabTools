...
drawtext(x(5), y(11), 'HP-HQ',F+2, dc);
...
drawlhv(x(2), y(5), x(16), y(10), 1, dc);
drawlhv(x(16), y(6), x(16), y(10), 0, dc);
drawlhv(x(5), y(7), x(11), y(9), 1, dc);
drawlhv(x(11), y(7), x(11), y(9), 1, dc);  
