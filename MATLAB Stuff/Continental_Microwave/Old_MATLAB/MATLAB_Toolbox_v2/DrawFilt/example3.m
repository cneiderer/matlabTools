function dr = example3(x0,y0,dx,ds,F);
...
drawtext(x(10),y(15),'Kerwin-Huelsman-Newcomb (KHN)',F+2,'b');
drawtext(x(10),y(14),'Analog Filter Realization',F+2,'b');
drawopam(x(6), y(7), x(9), ' ', 'A1', 1, ds, F, dc);
drawopam(x(12), y(6), x(15), ' ', 'A2', 1, ds, F, dc);
drawopam(x(18), y(5), x(21), ' ','A3', 1, ds, F, dc);
drawin(x(3), y(6), 'V1', 1, ds, F, dc);
