function [filename] = sys_comp_xls_Batch_ver(data,Master_FileList)

%
% sys_comp_xls_Batch_ver.m
%
% Description:
...
user_name=Master_FileList.user_name;
...
filename=fullfile('C:\MATLAB_Toolbox\Results\TWISTER_Related\Batch_Results',...
    [sys_name,'_system_compliance_',datestr(now,30),'.xls']);

disp(['*** Your system compliance spreadsheet will be saved as: ',...
    sys_name,'_system_compliance_',datestr(now,1),'.xls']);
