function [complete_data]=working_SpecCaseStudy_analysis(matfile_name)

%
% working_SpecAnalysis.m
%
% Description:
%
% Inputs:
...
%NB "RX" Files
Master_FileList.WB_TX_FileList={...
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\15.25 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\10.3 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\14.615 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\15.19 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\14.665 LH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\11.85 LH.cti'};
%NB "TX" Files
Master_FileList.WB_TX_FileList={...
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\15.25 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\9.85 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\14.125 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\14.615 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\14.665 RH.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\15.19 RH.cti'};
%WB "RX" Files
Master_FileList.WB_TX_FileList={...
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\RX WIDEBAND ANT\15.25.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\RX WIDEBAND ANT\14.615.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\RX WIDEBAND ANT\14.665.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\RX\RX WIDEBAND ANT\15.19.cti'};
%WB "TX" Files
Master_FileList.WB_TX_FileList={...
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\WIDE BAND\15.25.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\WIDE BAND\14.615.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\WIDE BAND\14.665.cti';
'F:\NEW_WARRIOR_DESIGN\NEW FULL TWISTER SYSTEM DATA\SN 010 FINAL TEST\TX\WIDE BAND\15.19.cti'};

Master_FileList.nstep=num_steps;
Master_FileList.GDSmoothie=GD_smooth;
Master_FileList.user_name=user;
Master_FileList.num_files=num_files;
complete_data.SN010_data=sys_comp_chk_Batch_ver(Master_FileList);

% 
disp({'';'Finished batch processing of TWISTER system compliance data.'})

%
if ~exist('matfile_name','var')
    matfile_name='default_batch_name';
end
save(['C:\MATLAB_Toolbox\Results\TWISTER_Related\',matfile_name,...
    datestr(now,30),'.mat'],'complete_data');

%% Create Excel Spreadsheet
disp({'';'Wrapping up TWISTER batch results into Spec_Case_Study workbook ...'});
working_SpecCaseStudy_xls(complete_data);
