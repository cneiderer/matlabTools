...
file='C:\SAT 1743 Data\System\SAT1736SN005\TX\15.25.cti';
file2='C:\SAT 1743 Data\System\IRAD2 Data\IRAD TX\15.195 RHCP.cti';
...
%     fmin=fc(ii)-W3/2;
    ...
    [w1MaxVar2(ii),w2MaxVar2(ii),w3MaxVar2(ii)]=MaxGDVar(fDV,GDV2,lengthw1,lengthw2);
...
if exc==0
    ...
    alpha(spec_alpha);
    subplot(2,2,2)
    plot(VarSpecXw2,VarSpecYw2,'g',1:length(w2MaxVar),w2MaxVar,':b',1:length(w3MaxVar),w2MaxVar2,'-.m','LineWidth',2.0)
    ...
    hold on;
    grid on
    plot(VarSpecXw3,VarSpecYw3,'g',1:length(w3MaxVar),w3MaxVar,':b',1:length(w3MaxVar),w3MaxVar2,'-.m','LineWidth',2.0)
    ...
    hold on;
    subplot(2,2,2)
    plot(VarSpecXw2,VarSpecYw2,'g',VarSpecXw2,VarExcYw2,'--r',1:length(w2MaxVar),w2MaxVar,':b',1:length(w2MaxVar),w2MaxVar2,'-.m','LineWidth',2.0)
    title([num2str(band),' Maximum Variation for any W2 window'],'fontsize',14,'fontweight','b');
    xlabel('# Window Steps');
    ylabel({'Delay Var (nS)',['(Max Var = ',num2str(max(w2MaxVar),3),')']});
    ...
    hold on;
    grid on
    plot(VarSpecXw3,VarSpecYw3,'g',VarSpecXw3,VarExcYw3,'--r',1:length(w3MaxVar),w3MaxVar,':b',1:length(w3MaxVar),w3MaxVar2,'-.m','LineWidth',2.0)
    title([num2str(band),' Maximum Variation for any W3 window'],'fontsize',14,'fontweight','b');
    xlabel('# Window Steps');
    ylabel({'Delay Var (nS)',['(Max Var = ',num2str(max(w3MaxVar),3),')']});
