...
X_Rx_CDL_RL   = 1; %toggles X-Band CDL RL Spec
...
file='C:\SAT 1743 Data\03-31 Analysis Data\RX\10.3 RX LHCP.cti';
file2='C:\SAT 1736-S RFE Data\SN_011\FINALTEST\RX\10.3.cti';
...
if exc==0
    ...
    legend('Specified Variation','Measured Data - IRAD','SAT 1736 - SN011','Location','EastOutside')
    grid on
    ...
    legend('Specified Variation','Measured - IRAD','SAT 1736 - SN011','Location','EastOutside')
    grid on
    hold off
else
    VarSpecYw1=[RPL1;RPL1];
    ...
    ylabel({'Amplitude (dB)',['(Max Var = ',num2str(max(w1MaxVar),2),')']},'fontsize',12);
    axis([1 length(w1MaxVar) 0 RPL1+.2+exc])
    legend('Specified Variation','Allowed Excursion','Measured Data - IRAD','SAT 1736 - SN011','Location','EastOutside')
    grid on
