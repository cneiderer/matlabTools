function IDD_cover_loaded_vbs(varargin)

%
% IDD_cover_loaded_vbs.m
%
% Description:
%   Builds macro to create a interdigital filter with cover loading within 
%   HFSS based on WEAFIL IDD data file.
%
% Inputs:
