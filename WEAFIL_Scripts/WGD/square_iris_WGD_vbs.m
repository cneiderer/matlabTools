function square_iris_WGD_vbs(varargin)

%
% square_iris_WGD_vbs.m
%
% Description:
%   Builds macro to create a waveguide filter with square irises within 
...
for mm=1:SymIris
    ...
    hfss_CreateBox(fid,['Iris',num2str(mm-1),num2str(mm)],...
        ...
        'Iris_Thickness',['Iris',num2str(mm-1),num2str(mm),'_width'],...
        filter_info.units.length,[85,85,85],0.5);
