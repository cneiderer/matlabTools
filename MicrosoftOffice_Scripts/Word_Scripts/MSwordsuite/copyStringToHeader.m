function copyStringToHeader(theString, theStyle, theAlignment)
% ---------------------------------------------------------------------
...
try,
    ...
    header = wordActiveX_GLOBAL.ActiveDocument.Sections.Item(1).Headers.Item('wdHeaderFooterPrimary').Range;
    font   = header.Font;
    
    % set the text
    header.Text = theString;
    ...
    % set the alignment
    header.Paragraphs.Alignment = alignStr;
    
catch,
    fprintf('%s: could not copy header text\n', mfilename);
