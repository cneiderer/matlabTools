...
switch length(varargin)
    case 0 
        % default color is charcoal
        varargin={'facecolor',[0.21176,0.21176,0.21176],'facealpha',0.8};
    case 1
        % use argument as color for faces
        varargin={'facecolor',varargin{1},'facealpha',0.8};
    case 2
        varargin={'facecolor',varargin{1},'facealpha',varargin{2}};
    otherwise
